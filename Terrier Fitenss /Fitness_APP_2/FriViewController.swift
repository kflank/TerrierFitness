...
class FriViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "friUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "friUserInputs")
    }
...
extension FriViewController: UITableViewDelegate, UITableViewDataSource {
