...
class SatViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "satUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "satUserInputs")
    }
...
extension SatViewController: UITableViewDelegate, UITableViewDataSource {
