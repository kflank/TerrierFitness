...
class WedViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "wedUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "wedUserInputs")
    }
...
extension WedViewController: UITableViewDelegate, UITableViewDataSource {
