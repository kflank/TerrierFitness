...
class TuesViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "tuesUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "tuesUserInputs")
    }
...
extension TuesViewController: UITableViewDelegate, UITableViewDataSource {
