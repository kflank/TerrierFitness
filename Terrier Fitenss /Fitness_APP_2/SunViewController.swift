...
class SunViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "sunUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "sunUserInputs")
    }
...
extension SunViewController: UITableViewDelegate, UITableViewDataSource {
