...
class MonViewController: UIViewController {
    ...
    let stringArraySaved = UserDefaults.standard.object(forKey: "monUserInputs") as? [String] ?? [String]()
    ...
    @IBAction func tapAddButton(_ sender: Any) {
        ...
        UserDefaults.standard.set(stringArray, forKey: "monUserInputs")
    }
...
extension MonViewController: UITableViewDelegate, UITableViewDataSource {
